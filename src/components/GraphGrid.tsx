	...
	useEffect(() => {
		...
		if (canvas) {
			...
			if (ctx) {
				...
				gradient.addColorStop(0, 'rgba(243, 247, 200, 0.6)'); // Fixed value from 6 to 0
				gradient.addColorStop(0.4, 'rgba(007, 174, 239, 0.7)'); // Fixed color value
				gradient.addColorStop(0.6, 'rgba(241, 238, 248, 0.7)');
				gradient.addColorStop(1, 'rgba(240, 200, 255, 0.6)'); // Fixed color value
				...
				ctx.lineWidth = 0.6; // Thinner lines for glass effect (fixed from 12.6 to 0.6)
