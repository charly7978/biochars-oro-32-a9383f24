...
export class HybridVitalSignsProcessor {
   ...
   */
  private async processHybrid(ppgValue: number, rrData?: RRIntervalData): Promise<VitalSignsResult> {
   ...
   * Main process method
   */
  public async process(ppgValue: number, rrData?: RRIntervalData): Promise<VitalSignsResult> {
